...
<body class="theme-teal">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="javascript:void(0);" id="hide-left-sidebar" style="padding-top: 10px"><i class="material-icons">more_vert</i></a>
        ...
        <aside id="leftsidebar" class="sidebar" >
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Mirella</div>
                    <div class="email">mirella@example.com</div>
                    <div class="btn-group user-helper-dropdown">
                        <i class="material-icons" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">keyboard_arrow_down</i>
                        <ul class="dropdown-menu pull-right">
                            <li><a href="javascript:void(0);"><i class="material-icons">person</i>Profile</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="javascript:void(0);"><i class="material-icons">settings_applications</i>Config</a></li>
                            <li role="separator" class="divider"></li>
    ...
    <section class="content" id="site-content">
        <!-- aqui vai o conteudo a ser exibido  por esse layout-->
        @yield('content')
    </section>
