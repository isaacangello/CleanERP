<div>
    @script
        <script>
            ...
            //         select:
            //             "border w-full border-gray-300 rounded-lg py-2 px-2 text-sm flex gap-2 items-start cursor-pointer bg-white",
            //         menuWrapper:
            //             "w-full rounded-lg py-1.5 text-sm mt-1 shadow-lg absolute bg-white z-10",
            //         menu: "max-h-52 overflow-y-auto",
            //         textList: "overflow-x-hidden text-gray-600 grow whitespace-nowrap",
            //         trigger: "px-2 py-2 rounded bg-green-800",
            //         badge: "py-1.5 px-3 rounded-full bg-green-800",
            //         search:
            //             "px-3 py-2 w-full border-0 border-b-2 border-neutral-300 pb-3 outline-0 mb-3",
            //         optionGroupTitle:
            //             "px-3 py-2 text-gray-600 uppercase font-bold text-xs sticky top-0 bg-white",
            //         clearSearchBtn: "absolute p-3 right-0 top-1 text-gray-600",
            ...
            //                     textList.innerHTML = '<span class="text-neutral-600">select</span>';
            //                 } else {
