...
<div    id="navBar"
        x-ref="navBar"
        class="flex flex-row w-full items-center p-6 bg-white border-b border-gray-300 md:fixed md:w-full md:top-0 md:z-20"
>

    <!-- logo -->
    <div class="flex flex-row items-center flex-none w-56">
        <button id="sliderBtn" class="flex-none block pr-2  text-right text-gray-900">
    ...
    <button id="navbarToggle" class="right-0 block fixed  md:hidden mr-6">
        <i class="fad fa-chevron-double-down"></i>
    </button>
    <!-- end navbar content toggle -->

    <!-- navbar content -->
    <div id="navbar" class="hidden  w-full  md:flex md:w-auto  items-center justify-between flex-1 pl-3 animated  md:top-0  md:left-0   md:border-gray-200  md:bg-white md:flex-row md:items-center">
        <!-- left -->
        <div class="text-gray-600  hidden md:w-auto md:flex md:flex-row md:justify-evenly ">
        ...
        <div class="flex flex-row-reverse items-center">
            ...
            <div class="relative dropdown md:static">
                ...
                <button @click="profileDropDown = ! profileDropDown"  class="flex flex-wrap items-center menu-btn focus:outline-none focus:shadow-outline">
                    <div class="w-8 h-8 overflow-hidden rounded-full">
                        <img class="object-cover w-full h-full" src="img/user.svg" alt="">
                    </div>
                ...
                <div
                        ...
                        class="absolute right-1 z-20  w-full py-2  text-gray-500 bg-white rounded shadow-md menu md:mt-8  md:w-40 animated faster"
                >
            ...
            <div class="relative mr-5 dropdown md:static">
                ...
                <div
                        ...
                        class="absolute right-2 z-20  py-2 mt-5 bg-white rounded shadow-md menu  w-84 md:right-44  md:w-84 md:mt-8  animated faster"
            ...
            <div class="relative mr-5 dropdown md:static">
                ...
                <div
                        ...
                        style="display: none !important;"
                        x-show="messages"
                        class="absolute right-0 z-20  py-2  bg-white rounded shadow-md menu md:w-84 md:right-1/3 mt-8 w-84 animated faster"
                >
                    <!-- top -->
                    <div class="flex flex-row items-center justify-between px-4 py-2 text-sm font-semibold capitalize">
                        <h1>messages</h1>
