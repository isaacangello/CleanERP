...
>
    ...
    <div class="flex flex-row items-center flex-none w-64">
        ...
        <img src="{{asset('img/logo.png')}}" class="flex-none w-[128px]" alt="logo">
{{--        <strong class="flex-1 ml-1 capitalize">CleanERP</strong>--}}
    ...
    <div id="navbar" class="  w-full hidden md:flex   items-center justify-between   animated  md:top-0  md:left-0   md:border-gray-200  md:bg-white md:flex-row md:items-center">
        ...
        <div class="flex flex-row-reverse items-center">
            ...
            <div class="relative dropdown md:static items-center">
                ...
                <button @click="togglePopUpContainer('profileDropDown'); profileDropDown = ! profileDropDown "  class="flex flex-wrap items-center menu-btn focus:outline-none focus:shadow-outline">
            ...
            <div class="relative mr-5 dropdown md:static">
                ...
                <button @click="togglePopUpContainer('notifications'); notifications = !notifications" class="p-0 m-0 text-gray-500 transition-all duration-300 ease-in-out menu-btn hover:text-gray-900 focus:text-gray-900 focus:outline-none">
            ...
            <div class="relative mr-5 dropdown md:static">
                ...
                <button @click="togglePopUpContainer('messages');messages = ! messages" class="p-0 m-0 text-gray-500 transition-all duration-300 ease-in-out menu-btn hover:text-gray-900 focus:text-gray-900 focus:outline-none">
    ...
    <!-- end navbar content -->
    <div x-show="popUpContainer"
         x-cloak
         style="display: none !important;"
         class="absolute top-16 right-1 z-20 flex gap-1"
    >
        <!--### start  messages ###############################################################################-->
        <div    x-show="messages"
                x-cloak
                x-transition:enter="animate__animated animate__backInRight animate__faster"
                x-transition:enter-start="opacity-0"
                x-transition:enter-end="opacity-100"
                x-transition:leave="animate__animated animate__backOutRight animate__faster"
                x-transition:leave-start="opacity-100"
                x-transition:leave-end="opacity-0"
                style="display: none !important;"
                class="  py-2 transition-transform duration-500 ease-in-out bg-white rounded shadow-md menu md:w-84 md:mt-10 md:right-1/3 mt-10 w-84 "
        >
            <!-- top -->
        ...
        <div    x-show="notifications"
                ...
                x-transition:leave-end="opacity-0"
                style="display: none !important;"
                class="  py-2 mt-10 bg-white rounded shadow-md menu  w-84 md:right-44  md:min-w-64 md:mt-10  animated faster"
        >
            <!-- top -->
            <div class="flex flex-row items-center justify-between px-4 py-2 text-sm font-semibold capitalize">
                <h1>notifications</h1>
            ...
            <!-- item -->
            <a class="flex flex-row items-center justify-start md:block px-4 py-4 text-sm font-medium tracking-wide capitalize transition-all duration-300 ease-in-out bg-white hover:bg-gray-200" href="#">
        ...
        <div    x-show="profileDropDown"
                ...
                x-transition:leave-end="opacity-0"
                style="display: none !important;"
                class="  w-full py-2 mt-10  text-gray-500 bg-white rounded shadow-md menu md:mt-10  md:w-64  animated faster"
        >
