        ...
        <div class="col s12 m2 input-field" >
            <div class="form-group">
                <div class="form-line success">
                    <select wire:model="selectedWeek"  class="form-control browser-default livewire-select font-15" >
        ...
        <div class="col s12 m2 input-field">
            <div class="form-group">
                <div class="form-line success">
                    ...
                    <select wire:model="selectedYear"  class="form-control browser-default livewire-select font-15">
