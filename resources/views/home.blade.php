...
@section('title')
    <title>Home - main - CleanERP 2</title>
@endsection
        ...
        <div class="col s12">
            <div class="card">
                ...
                <div class="body align-center">
                    ...
                    <p class="font-14 padding-0"><b>Florida: <span class="label bg-teal p-5" id="florida_time"></span> /
                            Brasil:<span class="label bg-cyan p-5" id="brazil_time"></span> </b></p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col s12 m12">
                <div class="card">
                    ...
                    <div class="body center-align">
                        <a target="_blank" href="https://meet.google.com/pbx-ngck-evi"><span
                                    class="label bg-green text-white p-5  font-13">Chamada Principal</span></a>
                        <a target="_blank" href="https://meet.google.com/vvh-zxmn-cjc"><span
                                    class="label bg-blue text-white p-5  font-13">Chamada Residencial</span></a><br
                                class="md:hidden"><br class="md:hidden">
                        <a target="_blank" href="https://meet.google.com/cot-jkcr-dgw"><span
                                    class="label bg-gray-500 text-white p-5 font-13">Chamada Comercial</span></a>
                        <a target="_blank" href="https://meet.google.com/mec-cngi-feo"><span
                                    class="label bg-amber-600 text-white p-5 font-13">Chamada Extra</span></a>
                    </div>
                </div>
            </div>
        </div>
